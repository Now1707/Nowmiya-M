class BankAccount:
  ...
  self.__account_holder_name = account_holder_nme
  self.__account_balance = initial_balance
  def deposit(self,amount):
    if amount > 0:
      self.__account_balance += amount
      print("deposited ₹{}. New balance: ₹{}".format(amount,
                                                     self.__account self.__account_balance))
    else:
...
account = BankAccount(account_number="123456789",account_holder_name="prabu",initial_balance=5000.0)
